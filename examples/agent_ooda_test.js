...
import { OODAAgent } from '../src/agent/ooda_agent.js';
...
(async () => {
  ...
  console.log('--- Running Interactive OODA Agent Test Workflow ---');
  ...
  const agent = new OODAAgent(agentLLM, availableTools);
  ...
  try {
    ...
    console.log('\n--- Interactive OODA Agent Test Workflow Finished ---');
    console.log('Final Agent Output:', finalResult);
  } catch (error) {
    console.error('\n--- Interactive OODA Agent Test Workflow Failed ---', error);
  }
})();
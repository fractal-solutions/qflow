...
import { LPAVRLAgent } from '../src/agent/lpavrl_agent.js';
...
(async () => {
  ...
  console.log('--- Running Interactive LPAVRL Agent Test Workflow ---');
  ...
  const agent = new LPAVRLAgent(agentLLM, availableTools);
  ...
  try {
    ...
    console.log('\n--- Interactive LPAVRL Agent Test Workflow Finished ---');
    console.log('Final Agent Output:', finalResult);
  } catch (error) {
    console.error('\n--- Interactive LPAVRL Agent Test Workflow Failed ---', error);
  }
})();
